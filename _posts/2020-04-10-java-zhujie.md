...
![](http://www.itwanger.com/assets/images/2020/04/java-zhujie-01.png)
...
3）`toJsonString()` 方法借助 Stream 流的方式返回格式化后的 JSON 字符串。如果对 Stream 流比较陌生的话，请查阅我之前写的 [Stream 流入门](https://mp.weixin.qq.com/s/7hNUjjmqKcHDtymsfG_Gtw)。

看完我的解释，是不是豁然开朗了？

![](http://www.itwanger.com/assets/images/2020/04/java-zhujie-02.gif)
