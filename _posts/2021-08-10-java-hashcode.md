...
layout: post
category: java
title: 为了彻底搞懂 hashCode，我连 JDK 的源码都没放过
tagline: by 沉默王二
tags: 
  - java
---
...
![](https://cdn.jsdelivr.net/gh/itwanger/itwanger.github.io/assets/images/2021/08/hashcode-01.png)
...
大家有没有想过这样一个问题：为什么 Object 类需要一个 `hashCode()` 方法呢？
...
![](https://cdn.jsdelivr.net/gh/itwanger/itwanger.github.io/assets/images/2021/08/hashcode-02.png)
...
我写了很多 Java 方面的系列文章，**有 Java 核心语法、Java 集合框架、Java IO、Java 并发编程、Java 虚拟机**等，也算是体系完整了。

![](https://img-blog.csdnimg.cn/fe4d33127f6f42a1912e1c1cee1e30bb.png)

为了能帮助到更多的 Java 初学者，我把自己连载的《[教妹学Java](https://itwanger.gitee.io/jmx-java/#/docs/string/constant-pool)》开源到了 GitHub，**尽管只整理了 50 篇，发现字数已经来到了 10 万+，内容更是没得说，通俗易懂、风趣幽默、图文并茂**。
