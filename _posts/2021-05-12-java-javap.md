...
![](http://www.itwanger.com/assets/images/2021/05/java-class-01.png)

Java 是跨平台的，JVM 作为中间层，自然要针对不同的操作系统提供不同的实现。拿 JDK 11 来说，它的实现就有上图中提到的这么多种。

![](http://www.itwanger.com/assets/images/2021/05/java-class-02.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-03.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-04.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-05.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-06.png)

前面还有 3 个字节，第一个字节 0x01 是标识，标识类型为 *CONSTANT_Uft8_info*，第二个和第三个自己 0x00 0x05 用来表示第三部分字节数组的长度。

![](http://www.itwanger.com/assets/images/2021/05/java-class-07.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-08.png)

*CONSTANT_String_info* 通过索引 19 来找到 *CONSTANT_Uft8_info*。

![](http://www.itwanger.com/assets/images/2021/05/java-class-09.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-10.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-11.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-12.png)

一个是 4，一个是 5，可以通过下图来表示 *CONSTANT_NameAndType_info* 的构成。

![](http://www.itwanger.com/assets/images/2021/05/java-class-13.png)

对应 class 文件中的位置如下图所示。

![](http://www.itwanger.com/assets/images/2021/05/java-class-14.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-15.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-16.png)

对应 class 文件中的位置如下图所示。

![](http://www.itwanger.com/assets/images/2021/05/java-class-17.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-18.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-19.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-20.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-21.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-22.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-23.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-24.png)

对应到 class 文件中的位置如下图所示。

![](http://www.itwanger.com/assets/images/2021/05/java-class-25.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-26.png)
...
![](http://www.itwanger.com/assets/images/2021/05/java-class-27.png)

到此为止，class 文件的内部算是剖析得差不多了，希望能对大家有所帮助。第一次拿刀，手有点颤，如果哪里有不足的地方，欢迎大家在评论区毫不留情地指出来！

超级硬核，解剖了超长时间，累坏了，记得帮我**点赞**鼓励下吧~