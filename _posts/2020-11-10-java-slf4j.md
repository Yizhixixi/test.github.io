...
layout: post
category: java
title: 阿里巴巴开发手册强制使用SLF4J作为门面担当的秘密，我搞清楚了
tagline: by 沉默王二
tags: 
  - java
---
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-01.png)

（维护和统一，把统一放在最后面读起来真的是别扭，和的有点牵强，请问手册的小编是数学老师教的语文吧？）

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-02.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-03.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-04.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-05.png)

但 JCL 好像并不怎么招人喜欢，有人是这样抱怨的：

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-06.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-07.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-08.png)

这就难受了！

Ceki Gulcu 想到了这个问题，并且帮我们解决了！来看 SLF4J 官网给出的解决方案。

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-09.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-10.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-11.png)

还有绑定 JUL 替换 JCL 和 Log4j 的方案：

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-12.png)

太强了，有木有？有的话请在留言区敲出 666。

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-13.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-14.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-15.png)

这也就意味着，如果日志系统的级别不是 DEBUG，就会多执行了字符串拼接的操作，白白浪费了性能。

注意，阿里巴巴开发手册上还有一条「**强制**」级别的规约：

![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-16.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-17.png)
...
![](http://www.itwanger.com/assets/images/2020/11/java-slf4j-18.png)
